...
ALTER TABLE AM_API_COMMENTS ADD CREATED_BY VARCHAR2(255)
/
ALTER TABLE AM_API_COMMENTS ADD CREATED_TIME DATE NOT NULL
/
ALTER TABLE AM_API_COMMENTS ADD UPDATED_TIME DATE DEFAULT NULL
/
...
/
ALTER TABLE AM_API_COMMENTS ADD FOREIGN KEY(PARENT_COMMENT_ID) REFERENCES AM_API_COMMENTS(COMMENT_ID) ON DELETE CASCADE
/