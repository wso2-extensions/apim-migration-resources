...
ALTER TABLE AM_API_COMMENTS ADD CREATED_TIME TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE AM_API_COMMENTS ADD UPDATED_TIME TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
