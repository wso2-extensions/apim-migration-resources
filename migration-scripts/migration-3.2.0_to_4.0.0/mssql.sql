...
ALTER TABLE AM_API_COMMENTS ADD CREATED_TIME DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE AM_API_COMMENTS ADD UPDATED_TIME DATETIME DEFAULT NULL;
