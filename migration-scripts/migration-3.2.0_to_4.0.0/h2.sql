...
ALTER TABLE AM_API_COMMENTS ALTER COLUMN COMMENTED_USER RENAME TO CREATED_BY;
ALTER TABLE AM_API_COMMENTS ALTER COLUMN DATE_COMMENTED RENAME TO CREATED_TIME;
